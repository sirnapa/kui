 ...
 *
 */
function(a){a.kForms={instances:{}},a.fn.kForm=function(c){return this.each(function(){a.kForms.instances[this.id]=new b(this,c)})};var b=function(a,b){return void 0===b.campos||void 0===b.submit?void window.console.error('Los parámetros "campos" y "submit" son obligatorios.'):(this.div=a,this.campos=b.campos,this.submit=b.submit,this.origen=b.origen,this.ajax_origen=void 0===b.ajaxOrigen?"GET":b.ajaxOrigen,this.ajax_submit=void 0===b.ajaxSubmit?"POST":b.ajaxSubmit,this.load_complete=b.loadComplete,this.boton_submit=b.botonSubmit,this.solo_lectura=void 0===b.soloLectura?!1:b.soloLectura,this.data_origen=b.dataOrigen,void this.cargar())};b.prototype={nuevo_form:function(){var b=this;b.form=a("<form>").attr("id",b.div.id+"_form").addClass("kform form-horizontal").attr("action","#").prependTo(b.div),b.seleccionable&&b.seleccionar(b.preseleccionados)},nuevo_mensaje:function(b,c){var d=this;d.mensaje&&d.mensaje.remove(),d.mensaje=a("<div>").attr("role","alert").addClass("alert").addClass(b?b:"alert-info").html(c).prependTo(d.div),a("<button>").attr("data-dismiss","alert").addClass("close").attr("type","button").html('<i class="fa fa-times"></i>').appendTo(d.mensaje)},cargar:function(){var b=this;b.form?b.form.empty():b.nuevo_form(),void 0===b.origen?b.dato={}:"string"==typeof b.origen&&a.ajax({type:b.ajax_origen,url:b.origen,data:b.data_origen,success:function(a){a.error||(b.dato=a.objeto)},async:!1}),b.cargar_campos()},cargar_campos:function(){var b=this,c=b.dato,d=a("<fieldset>").appendTo(b.form);b.solo_lectura&&d.attr("disabled",!0),a.each(b.campos,function(e,f){var g=a("<div>").addClass("form-group").appendTo(d);void 0===f.titulo&&(f.titulo=f.nombre),a("<label>").addClass("klabel col-md-3 control-label").html(f.titulo).appendTo(g);var h=a("<div>").addClass("col-md-6").appendTo(g);a("<div>").addClass("col-md-3").appendTo(g),a.kui.formulario.nuevo_elemento(b.solo_lectura,h,c,f)}),a(b.div).data("dato",b.dato),b.funcion_submit(),"function"==typeof b.load_complete&&b.load_complete.call(this,b.dato)},funcion_submit:function(){var b=this;b.boton_submit=void 0===b.boton_submit?a("<button>").addClass("btn btn-primary").html("Guardar").appendTo(a("<div>").addClass("form-group text-right").appendTo(b.form)):a(b.boton_submit),b.boton_submit.click(function(){b.form.submit()}),a.kui.formulario.validar.reglas();var c="function"==typeof b.submit?function(){b.submit.call(this,b.contenido(),b.dato)}:function(){a.ajax({type:b.ajax_submit,url:b.submit,data:b.contenido(),success:function(a){a.mensaje&&b.nuevo_mensaje(a.tipoMensaje,a.mensaje)},async:!1})};a(b.form).validate({showErrors:function(b,c){a.kui.formulario.validar.error(this,b,c)},submitHandler:function(b){return a.kui.formulario.validar.fecha(b),c(),!1}})},contenido:function(){var a=this;return a.form.serialize()}}}(jQuery);