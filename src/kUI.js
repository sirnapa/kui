...
(function () {
    ...
    $.kUI = {
    	...
    	formulario: {
    		...
    		elemento: function(solo_lectura,elemento,item,campo){
                 ...
                 var crear_input_select = function(tipo){
                    return $('<'+tipo+'>').addClass('form-control')
                        ...
                        .attr('title',
                            ...
                            'El formato ingresado no es correcto para ' 
                            + campo.titulo : campo.mensaje)
                        .val(valor_input())
        ...
        validaciones: {
	        ...
	        fechas: function(form){
	            $(form).find('input[data-rule-date=true]').each(function(i,input){
	                ...
	                $(input).val(
	                        (fechaArray.length==3)?
	                                (fechaArray[fechaFormato.yyyy]+'-'
	                                +fechaArray[fechaFormato.MM] +'-'
	                                +fechaArray[fechaFormato.dd])
	                        : ''
	                );
	            });
	        }
